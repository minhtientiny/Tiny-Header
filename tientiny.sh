...
echo "";
echo -e "\e[1;34m[</>] \e[32mĐang Tải Xuống Gói....\e[0m";
echo "";
...
║\e[1;90m   ╚═╝   ╚═╝╚═╝  ╚═══╝   ╚═╝       ╚═╝  ╚═╝╚══════╝╚═╝  ╚═╝╚═════╝ ╚══════╝╚═╝  ╚═╝\e[1;32m║
║═══════════════════════════════════════════════════════════════════════════════════║
║\e[1;34m*Menu*\033[01;32m                                                                             ║
║1. Terminal-Header-TienTiny                                                        ║
║2. Chỉ Dành Cho Người Dùng....                                                     ║
╚═══════════════════════════════════════════════════════════════════════════════════╝
\033[0m";
ok=0
while [ $ok = 0 ];
...
tput setaf 3
read -p  "Bạn Có Muốn Thiết Lập? (y/n) " PROC32
tput sgr 0
if [[ ${PROC32} == [Y/y] ]]; then
...
source ~/.zshrc;
	...
	echo -e "\033[32mLỗi, Vui Lòng Thử Lại....\033[0m"
fi
exit
}
#═╝╚╔╗║
...
║\e[1;90m   ╚═╝   ╚═╝╚═╝  ╚═══╝   ╚═╝       ╚═╝  ╚═╝╚══════╝╚═╝  ╚═╝╚═════╝ ╚══════╝╚═╝  ╚═╝\e[1;32m║
║═══════════════════════════════════════════════════════════════════════════════════║
║\e[1;34m*Gói Cần Thiết Để Tải*\e[1;32m                                                             ║
║1. Oh-my-zsh                                                                       ║
...
if [ -d $HOME/.plugins/zsh-syntax-highlighting ];then
	...
	echo -e "\e[1;34m[</>] \033[32mLỗi, Vui Lòng Thử Lại....\033[0m"
	exit
fi
exit 0
